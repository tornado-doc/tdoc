...
t('the onboarding dialog is onboarding, not a doc launcher (#371)', () => {
  ...
  assert(onboarding.includes('className={`tdoc-wiz-line${lineCopy.copied ? \' copied\' : \'\'}`}>') && onboarding.includes('{FIRST_DOC_RECIPE}'), 'the recipe is what the own-agent door hands over');
