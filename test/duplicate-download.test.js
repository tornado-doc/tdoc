...
t('published React actions say Duplicate and Download, not Fork', () => {
  ...
  assert(overlay.includes('data-action="share"') && overlay.includes("demotePrimary ? '' : ' tdoc-mobile-overflow-only'"),
    'Share stays primary on desktop unless Send-to-agent demotes it into overflow on every width');
