...
t('Create a doc is a two-card fork rendered by the shared component', () => {
  ...
  assert(/copied === true \? 'Copied — now paste it into your agent' : copied === false \? 'Select & copy' : 'Copy the line'/.test(choice), 'Copy feedback state missing (three states: idle, copied, clipboard refused)');
