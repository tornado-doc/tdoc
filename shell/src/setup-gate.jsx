...
function AgentMarks() {
  return (
    <span className="sg-marks" title="Works with Claude Code and ChatGPT" aria-label="Works with Claude Code and ChatGPT">
      <svg viewBox="0 0 248 248" width="16" height="16" aria-hidden="true" focusable="false">
