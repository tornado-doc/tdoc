...
const TDOC_LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="-111.391 -301.011 1000 1000" role="img" aria-label="tdoc">
  <g transform="translate(-123.097585,711.963561) scale(0.1,-0.1)" fill-rule="evenodd">
    <!-- Body: opaque silhouette (the outer contour of the line art), so the
         mark is a solid shape rather than a see-through outline. Matches the
         raster it replaced, which was fully opaque. Inverts with the page in
         dark mode, giving ink-on-dark. -->
    <path fill="#ffffff" d="M2705 7105 c-33 -9 -110 -40 -171 -70 -102 -51 -116 -55 -180 -55
...
79z"/>
    <!-- Ink: the line art itself. currentColor so an inlined copy follows
